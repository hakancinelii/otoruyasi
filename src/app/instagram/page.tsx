  ...
  return (
    <main className="container">
      <div style={{ marginBottom: '40px', marginTop: '40px', display: 'flex', alignItems: 'center', gap: '15px', flexWrap: 'wrap' }}>
        <h1 style={{ fontSize: '36px', margin: 0, fontWeight: 800 }}>Instagram'da Bizi Takip Edin</h1>
        <a href="https://www.instagram.com/otomobilruyasi/" target="_blank" rel="noopener noreferrer" className="btn-primary" style={{ background: '#E1306C', color: '#fff', padding: '8px 16px', borderRadius: '20px', fontSize: '14px', textDecoration: 'none', display: 'flex', alignItems: 'center', gap: '8px', border: 'none' }}>
